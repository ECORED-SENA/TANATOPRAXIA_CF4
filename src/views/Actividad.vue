  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 ¿Cuál es el complemento del otro?
        p.mb-4 Reconocer la comprensión de conceptos desarrollados por el aprendiz durante el componente de formación. 
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Clasificar conceptos.
            .col-auto
